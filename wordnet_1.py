...
joblib.dump(wordnetSimilarity, '2lkh_2_35_lkh_wordnetSimilarity_pickle_file.pkl')       
#   ----------------------comment----------------------------------------
   ## doc to vec
...
with open('2lkh_2_35___wordnetSimilarity.csv', 'w') as csvfile:
    fieldnames = ['question_1', 'question_2','Is_duplicate','WordnetSimilarity']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader()
    for i in range (0,len(X_train)):        
        writer.writerow({'question_1': X_train[i][3], 'question_2': X_train[i][4],'Is_duplicate':X_train[i][5],'WordnetSimilarity':wordnetSimilarity[i]})
csvfile.close()  
#
